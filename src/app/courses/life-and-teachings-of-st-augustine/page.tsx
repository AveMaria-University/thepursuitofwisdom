...
export default function AugustineCoursePage() {
	const course = getCourseBySlug('life-and-teachings-of-st-augustine');
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<main className="relative">
				{/* Full-width background section - Augustine specific height */}
				<div 
				...
				>
					...
					<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-0 relative z-10">
						{/* Video + Description Card - Augustine original styling */}
