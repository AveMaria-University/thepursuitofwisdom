...
export default function MotherhoodCoursePage() {
	const course = getCourseBySlug('philosophy-of-motherhood');
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<main className="relative">
				...
				<div 
					className="relative left-1/2 right-1/2 -mx-[50vw] w-screen h-[950px]"
					style={{
				...
				{/* Program Outline / Lessons with background image - TALLER FOR MOTHERHOOD */}
				<section 
					id="program" 
					className="relative"
					style={{
						...
						backgroundPosition: 'center',
						backgroundRepeat: 'no-repeat',
						minHeight: 'calc(100vh + 50px)' // 50px taller than normal
					}}
				>
					{/* Light overlay for explore background */}
					<div className="absolute inset-0 bg-white opacity-80 pointer-events-none" />
					<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
						<h3 className="font-crimson font-bold text-3xl md:text-4xl text-gray-900 mb-12 text-center">Explore the Program</h3>
				...
				{(course.presenterBio || course.presenterImage) && (
					<section className="relative left-1/2 right-1/2 -mx-[50vw] w-screen bg-pursuit-gold pb-0">
