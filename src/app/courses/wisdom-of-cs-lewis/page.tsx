...
export default function LewisCoursePage() {
	const course = getCourseBySlug('wisdom-of-cs-lewis');
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<main className="relative">
				...
				<div 
					className="relative left-1/2 right-1/2 -mx-[50vw] w-screen h-[925px]"
					style={{
				...
				{/* Program Outline / Lessons with background image - 25px TALLER FOR LEWIS */}
				<section 
					id="program" 
					className="relative"
					style={{
						...
						backgroundPosition: 'center',
						backgroundRepeat: 'no-repeat',
						minHeight: 'calc(100vh + 45px)' // 45px taller than normal
					}}
				>
