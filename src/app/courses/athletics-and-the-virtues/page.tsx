...
export default function PattersonCoursePage() {
	const course = getCourseBySlug('athletics-and-the-virtues');
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<main className="relative">
				{/* Full-width background section - Patterson specific height */}
				<div 
