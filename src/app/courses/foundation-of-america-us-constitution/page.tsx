...
export default function McGuireCoursePage() {
	const course = getCourseBySlug('foundation-of-america-us-constitution');
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<main className="relative">
				...
				{/* Program Outline / Lessons with background image */}
				<section 
					id="program" 
					className="relative"
					style={{
