...
export default function FultonSheenCoursePage() {
	const course = getCourseBySlug('wisdom-of-fulton-sheen');
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<main className="relative">
				...
				{/* Program Outline / Lessons with background image - FULL HEIGHT */}
				<section 
					id="program" 
